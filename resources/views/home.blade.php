...
<body>
    <div id="app">
        @include('layouts.nav')
        <main class="">
            <div class="jumbotron" style="width:1350px; height: 565px; margin-bottom:0%; background-image: linear-gradient(to right, #360033,#0b8793); color: #efefef;">
                <div class="container">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex">
                            <div class=""> 
                                ...
                                <h5 style="margin-top:70px;">Date: {{date('d-m-Y')}} | Time: {{date('H:i:s')}} | Day: {{date('l')}}</h5>
                            </div>
                        </div>         
                        <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" class="bi bi-pc-display-horizontal" viewBox="0 0 16 16">
